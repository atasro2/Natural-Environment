package com.masstrix.natrual.items;
...
public class RecipeItems {
    ...
    private static ItemStack leafBall() {
    ...
    private static ItemStack hydrationChestplateItem1() {
    ...
    private static ItemStack hydrationChestplateItem2() {
        CustomStack stack = new CustomStack(Material.IRON_CHESTPLATE);
        stack.setAmount(1);
    ...
    private static ItemStack hydrationChestplateItem3() {
    ...
    private static ItemStack advancedClock() {
