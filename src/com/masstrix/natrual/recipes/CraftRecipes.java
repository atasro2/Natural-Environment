...
public class CraftRecipes {
    ...
    public void register() {
        ...
        registerRecipe(nametag(), leafBall(), slimeBall(), campfire(), advancedClock(), pump(),
                hydrationChestplate1(), hydrationChestplate2(), hydrationChestplate3());
    }

    private void registerRecipe(Recipe... recipes) {
        for (Recipe r : recipes) Bukkit.getServer().addRecipe(r);
    }
